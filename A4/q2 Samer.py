...
# list and appends it to the end. After doing so, it will repeat this process 
# two more times and return the resulting list. You can choose to use a loop or 
# manually use three lines. Here are the steps we need:
