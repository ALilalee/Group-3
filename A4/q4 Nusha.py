...
#  of different types of snacks represented by different numbers. 
...
#  and another number as the third parameter (the maximum number of that type of
#  snack on the conveyor belt). The function will return True if the snack we are
#  searching for appears more times than we provided as our third parameter. 
